...
<!-- Modal -->
<div class="modal fade" id="msgModal<?php echo $fr['f_id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <form class="form-horizontal" role="form" action="?act=write_msg" method="post">
          <div class="modal-body">
        			  <div class="form-group">
        			    ...
        			    <div class="col-sm-9"> 
        			      <input type="text" name="name" class="form-control" id="name" value="<?php echo $fr['name']." ".$fr['surname'];?>" readonly>
        			    </div>
        			  </div>
        			  <div class="form-group">
        			    ...
        			    <div class="col-sm-9"> 
            			      ...
            			      <input type="hidden" name="fid" value="<?php echo $fr['f_id'];?>">
        			    </div>
        			  </div><br>
          </div>
